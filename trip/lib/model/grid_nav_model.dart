...
class GridNavItem{
  ...
  GridNavItem({required this.startColor, required this.endColor, required this.mainItem, this.item1, required this.item2, required this.item3, required this.item4});
